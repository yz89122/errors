...
func TestFrameFormat(t *testing.T) {
	var tests = []struct {
		...
		initpc,
		"%+s",
		"github.com/yz89122/errors.init\n" +
			"\t.+/stack_test.go",
	}, {
		0,
		"%s",
...
func TestFuncname(t *testing.T) {
	tests := []struct {
		...
		{"", ""},
		{"runtime.main", "main"},
		{"github.com/yz89122/errors.funcname", "funcname"},
		{"funcname", "funcname"},
...
func TestStackTrace(t *testing.T) {
	tests := []struct {
		...
		New("ooh"), []string{
			"github.com/yz89122/errors.TestStackTrace\n" +
				"\t.+/stack_test.go:121",
		},
	}, {
		...
		func() error { return New("ooh") }(), []string{
			`github.com/yz89122/errors.TestStackTrace.func1` +
		...
		Cause(func() error {
			...
			`github.com/yz89122/errors.TestStackTrace.func2.1` +
				"\n\t.+/stack_test.go:145", // this is the stack of Errorf
			`github.com/yz89122/errors.TestStackTrace.func2` +
...
func TestStackTraceFormat(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"\n" +
			"github.com/yz89122/errors.stackTrace\n" +
			"\t.+/stack_test.go:174\n" +
			"github.com/yz89122/errors.TestStackTraceFormat\n" +
			"\t.+/stack_test.go:225",
	}, {
		stackTrace()[:2],
		"%#v",
